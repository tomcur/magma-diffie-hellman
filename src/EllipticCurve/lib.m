declare type CryptoCrvEll[CryptoPtEll]: FinCycGrp;
declare type CryptoPtEll: FinCycGrpElt;
...
intrinsic GeneratingElement(crv::CryptoCrvEll) -> CryptoPtEll
...
intrinsic Order(crv::CryptoCrvEll) -> RngIntElt
...
intrinsic '^'(e::CryptoPtEll, n::RngIntElt) -> CryptoPtEll
{Return e^n.}
    e`Value := e`Value * n;
    return e;
end intrinsic;
